...
cspeed <- function(x, p = .05) mean(sort(x)[-(1:round(length(x) * p))])

head(sort(vel)[-(1:round(length(vel) * .05))])
...
barplot(table(cut(vel, c(0, 31, 34, 37, 40, 100))))
